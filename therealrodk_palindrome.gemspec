...
Gem::Specification.new do |spec|
  spec.name          = "therealrodk_palindrome"
  spec.version       = TherealrodkPalindrome::VERSION
  spec.authors       = ["Rod K"]
  spec.email         = ["rodk@example.com"]

  spec.summary       = %q{Palindrome detector}
  spec.description   = %q{Learn Enough Ruby palindrome detector}
  spec.homepage      = "https://github.com/therealrodk/therealrodk_palindrome"
  spec.license       = "MIT"
